...
<head>
    ...
    <!-- Custom CSS -->
    <link href="resources/index/css/stylish.css" rel="stylesheet">
...
<body>
  <!-- Navigation -->
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-brand">
                <a href="#top" onclick=$("#menu-close").click();>Predicto</a>
            </li>
            <li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <img class="img-portfolio img-responsive" src="resources/index/img/portfolio1.jpg">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <img class="img-portfolio img-responsive" src="resources/index/img/portfolio2.jpg">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <img class="img-portfolio img-responsive" src="resources/index/img/portfolio3.jpg">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <img class="img-portfolio img-responsive" src="resources/index/img/portfolio4.jpg">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <section id="contact" class="map">
        <iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=L.+D.+Colleg+Of+Engineering,+Ahmedabad,+India&amp;aq=0&amp;oq=twitter&amp;sll=28.659344,-81.187888&amp;sspn=0.128789,0.264187&amp;ie=UTF8&amp;hq=Twitter,+Inc.,+Market+Street,+San+Francisco,+CA&amp;t=m&amp;z=15&amp;iwloc=A&amp;output=embed"></iframe>
        <br />
        <small>
            <a href="https://www.google.co.in/maps/place/L.D.+College+of+Engineering/@23.0338,72.5443953,17z/data=!3m1!4b1!4m5!3m4!1s0x395e84eaf57ac615:0x5c7498bb96b34c97!8m2!3d23.0338!4d72.546584"></a>
        </small>
    </section>
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    ...
                    <ul class="list-unstyled">
                        <li><i class="fa fa-phone fa-fw"></i> (942) 645 1295</li>
                        <li><i class="fa fa-envelope-o fa-fw"></i> <a href="mailto:aprojects66@gmail.com">admin@project.com</a>
                        </li>
                    </ul>
                    <br>
    ...
    <script src="resources/index/js/bootstrap.js"></script>
